// api key
const api="api_key=18a23ae4a44812687b9b9fa16e923e66";
// base url
...
//used to truncate the  movie description
...
fetch(requests.fetchNetflixOrignals)
    ...
    .then((data) => {
        ...
        let banner_des=document.getElementById("banner-description");
...
fetch(requests.fetchNetflixOrignals)
    ...
    .then((data)=>{
        ...
        data.results.forEach(movie => {
            ...
            poster.className="row-posterslarge";
